...
extensions = [
    ...
    Extension(name='PyML/classifiers/ext/_mylibsvm',
              ...
              include_dirs=include_dirs),
    Extension(name='PyML/classifiers/ext/_pegasos',
              sources=['PyML/classifiers/ext/Pegasos_wrap.cxx',
                       'PyML/classifiers/ext/Pegasos.cpp',
                       'PyML/containers/ext/DataSet.cpp',
                       'PyML/containers/ext/Kernel.cpp'],
              include_dirs=include_dirs),
...
setup(name=name,
      ...
      ext_modules=extensions, requires=['numpy']
      #extra_path = 'PyML'
)
